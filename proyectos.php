<section id="proyectos" class="portfolio" data-aos="fade-up">

    <div class="container">

      <div class="section-header">
        <h2>Proyectos</h2>
        <p>Aqui algunos trabajitos que he realizado en el desarrollo de aplicaciones tanto para empresas,
          universitarios y personales. </p>
      </div>
